...
<div class="literally-want-to-die">
...
<div class="information-wrapper">
    <div id="about-wrapper">
        <div class="about-container">
            ...
            <div class="about-underline">
                
            </div>
            <img class="about-image" src="img/memberimg3.jpg" alt="">
        </div>
    </div>
...
<div class="information-sub-wrapper">
    ...
    <div id="services-wrapper">
        <div class="container-2-wrapper">
            ...
            <div class="container-2-text">
                <p class="container-2-info">MPA maintains an <a href="search-bar.php">"Provider Membership & Referral Directory"</a> for individuals and groups who are seeking clinical services. The psychologists participating in the referral service are all licensed psychologists who can provide services such as individual and group therapy, psychological testing, and consultation to individuals, groups and organizations. Multilingual therapists and therapists trained to help individuals or groups with special needs are available.
            ...
            <div class="container-3">
                ...
                <div class="container-2-text">
                    ...
                    <div class="member-container">
                        ...
                        <div class="row-1">
                            <div class="board-1">
                                <p class="board-info"><span class="text-color"> Joseph A. Parisi, Ph.D.</span></p>
                                <p class="board-info">President</p>
                                <p class="board-info">jp@drjoeparisi.com</p>
                            </div>

                            <div class="board-2">
                                <p class="board-info"><span class="text-color">Amy Combs, Psy.D.</span></p>
                                <p class="board-info">Past-President</p>
                                <p class="board-info">ac@dramycombs.com</p>
                            </div>

                            <div class="board-3">
                                <p class="board-info"><span class="text-color">Nona Patterson, Ph.D.</span></p>
                                <p class="board-info">Secretary</p>
                                <p class="board-info">drnlpatterson@mac.com</p>
                            </div>
                             <div class="board-4">
                                <p class="board-info"><span class="text-color">Open Position</span></p>
                                <p class="board-info">Treasurer</p>
                                <p class="board-info"></p>
                            </div>
                            <div class="board-5">
                                <p class="board-info"><span class="text-color">Kevin Gyoerkoe, Psy.D.</span></p>
                                <p class="board-info">Member-at-Large</p>
                                <p class="board-info">kgyoerkoe@gmail.com</p>
                            </div>
                            <div class="board-6">
                                <p class="board-info"><span class="text-color">Audrey File, Ph.D.</span></p>
                                <p class="board-info">Member-at-Large-early-career</p>
                                <p class="board-info">AshtonIntegrativeHealth@gmail.com</p>
                            </div>
