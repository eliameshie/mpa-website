    ...
    <body>
        <div id="container">
            ...
            <ul class="faq">
                ...
                <li class="a">
                    <ul>
                        <li class="bullet-1">When you feel as if you can't do it alone
                        </li>
                        <li class="bullet-2">When you feel trapped, as if there is nowhere to turn
                        </li>
                        <li class="bullet-3">When you worry all the time, and never seem to find answers
                        </li>
                        <li class="bullet-4">When the way you feel is affecting your sleep, your eating habits, your job, your relationships, your everyday life
                        </li>
                        <li class="bullet-5"> When issues such as marital or family problems, child rearing, severe illness or injury, death of a loved one, career changes, school problems, or crises associate with aging are making it difficult to cope with the routine demands of daily living.
                        </li>
                    </ul>
                </li>
                ...
                <li class="a">Many health plans, including HMOs, provide some level of coverage for psychological services.
                    <br>
                ...
                <li class="a">
                    <ul>
                        ...
                        <li class="bullet-2"> Ask about co-payments, deductibles, and annual or lifetime maximums.
                        </li>
                        <li class="bullet-3">Ask who determines how many treatment sessions will be covered, and how/when that decision is made.
                        </li>
                        <li class="bullet-4">Ask what you can do if your coverage is denied or cut short.
                        </li>
                        <li class="bullet-5">Find out if there is a group of providers, a "network" that you must choose from, or if you can choose any qualified provider. If you can choose any qualified provider, find out what licenses or degree he or she must have before coverage is authorized.
                        </li>
                    </ul>
                </li>
